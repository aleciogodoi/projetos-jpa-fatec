...
@Entity
@PrimaryKeyJoinColumn(referencedColumnName="idCliente")
...
public class PessoaJuridica extends Cliente{
	...
	public String toString() {
		return "Pessoa Jurídica [inscrição Estadual=" + inscricaoEstadual + ", Inscrição Municipal=" + inscricaoMunicipal
				+ ", CNPJ=" + cnpj + ", Razão Social=" + razaoSocial + "]";
	}
