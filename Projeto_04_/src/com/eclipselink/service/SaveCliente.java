...
public class SaveCliente {
	...
	public static void main(String[] args) {
		...
		PessoaFisica pf03 = new PessoaFisica(3, "Alan", "Rua das Gertrudes, 123 - Centro", "11 943253243",
				"alan@email.com", "11111-1", "2222222-34", "M");

		// Pessoa Jurídica
		PessoaJuridica pj01 = new PessoaJuridica(4, "Xpto", "Av. Das Nações, 434", "xpto@email.com", "11 55558888",
				"000212121-98", "57575677-54", "0202018/0001-12", "Xpto Ltda");

		// Pessoa Jurídica
		PessoaJuridica pj02 = new PessoaJuridica(5, "ABC System", "Av. Riachuelo, 1001", "abcsystem@email.com",
